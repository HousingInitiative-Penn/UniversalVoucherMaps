...
map_states_voucher_gap <- map %>% setView(lng = -98.34,
  ...
  htmlwidgets::onRender("
        function() {
            $('.legend').prepend('<label style=\"text-align:left\">Voucher Gap Ratio at: </label><br>');
        }
    ") %>%
  htmlwidgets::onRender("
        function() {
...
map_states_vouchers_scenarios <- map %>% setView(lng = -96.34,
  ...
  htmlwidgets::onRender("
        function() {
            $('.legend').prepend('<label style=\"text-align:left\"><strong>Expected Households<br>Served at</strong></label><br>');
        }
    ") %>%
  htmlwidgets::onRender("
        function() {
...
map_breakouts <- map %>% setView(lng = -98.34,
  ...
  htmlwidgets::onRender("
   ...
   htmlwidgets::onRender("
        function() {
            $('.legend').prepend('<label style=\"text-align:left\"><strong>Expected Households<br>Served at 30% AMI</strong><br></label><br>');
        }
    ") %>%
  htmlwidgets::onRender("
        function() {
